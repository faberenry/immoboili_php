...
<main id="main" class="center-text">
  <div id="chat" style="width: 602px; height: 670px; background-color: orange; border-color: black; border: solid 1px" >
    <input type="text" id="handle" placeholder="Nome Utente" 
            style="height: 30px; border: none; width: 596px; text-align: center; background-color: orange; border-radius: 30px" />
    <div id="chat-window">
        <div id="output"> 
    ...
    <input type="text" id="message" placeholder="  Scrivi qui" 
            style="width: 555px; height: 30px; background-color: orange; border: none; border-radius: 5px;" />
