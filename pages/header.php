                    ...
                    <div class="container-fluid">
                      ...
                      <a class="navbar-brand">
                        ...
                        <button type="button" class="btn btn-primary" style="background-color: transparent; border-color: transparent;">
                          <a href="./pages/includes/router.inc.php?url=main" id="butTypeA1" >Home</a></button>
                        <button type="button" class="btn btn-primary" style="background-color: transparent; border-color: transparent;">
                          <a class="btn btn-light" href="./pages/includes/router.inc.php?url=chiSiamo" id="butTypeB1" >Chi siamo</a></button>
                        <button type="button" class="btn btn-primary" style="background-color: transparent; border-color: transparent;">
                          <a class="btn btn-light" href="./pages/includes/router.inc.php?url=contatti" id="butTypeB2" >Contattaci</a></button>
                        <button type="button" class="btn btn-primary" style="background-color: transparent; border-color: transparent;">
                          <a class="btn btn-light" href="./pages/includes/router.inc.php?url=offerte" id="butTypeB3" >Offerte</a></button>
